...
class ProductPage(BasePage):
    ...
    def should_be_product_added_to_basket_message_has_same_product_name(self):
        ...
        assert name_of_product_added_to_basket_message == product_name, \
            "'Product in added to basket message' has different name"
    ...
    def should_be_basket_total_equal_to_product_price(self):
        ...
        assert basket_total == product_price, \
            "Basket total is not equal to product price"
    ...
    def should_disappear_success_message(self):
        assert self.is_disappeared(*ProductPageLocators.PRODUCT_ADDED_TO_BASKET_MESSAGE), \
            "Success message didn't disappear, but should do"